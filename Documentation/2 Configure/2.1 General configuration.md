...
- **keys**:
    ...
    - **key**: Name of the parameter for the *key* parameter. Parameter type `string` expected.
    - **tokens**: Name of the parameter for the *tokens* parameter. Parameter type `float` expected.
    - **daily**: Name of the parameter for the *daily* parameter. Parameter type `int` expected.
    - **date**: Name of the parameter for the *date* parameter. Parameter type `string` expected.
    - **default**: Name of the parameter for the *default* parameter. Parameter type `string` expected.
    - **admin**: Name of the parameter for the *admin* parameter. Parameter type `int` expected.
    - **temporal_conversations**: Name of the parameter for the *temporal_conversation* parameter. Parameter type `string` expected.
- **conversations**:
    ...
    - **conversation_name**: Name of the parameter for the *conversation_name* parameter. Parameter type `string` expected.
    - **conversation_data**: Name of the parameter for the *conversation_data* parameter. Parameter type `string` expected.
    - **temporal**: Name of the parameter for the *temporal* parameter. Parameter type `string` expected.
- **memories**:
    - **table**: Name of the table where the memories will be stored.
    - **user**: Name of the parameter for the *user* (key) parameter. Parameter type `string` expected.
    - **memory**: Name of the parameter for the *memory* parameter. Parameter type `string` expected.
