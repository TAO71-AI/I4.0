...
# enabled_plugins
Set the plugins that I4.0 is capable to use.
...
# allow_data_share
Shares every prompt and I4.0's response to all the servers specified.
...
# data_share_timeout
The maximum time (in seconds) to connect to each server of the **data_share_servers**.
