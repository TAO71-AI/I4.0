...
namespace TAO.I4.Plugins.Voicevox
{
    public static class KatakanaTranslator
    {
        ...
        public static string EStoJA(string Text)
        {
            ...
            return TranslateFromDictionary(Text, table, 2);
        }

        public static string ENtoJA(string Text)
        {
            Dictionary<string, string> table = new Dictionary<string, string>()
            {
                // Vocals
                {"a", "エイ"}, {"i", "アイ"}, {"y", "ワイ"}, {"u", "ユー"}, {"e", "イー"}, {"o", "オー"},
                // k
                {"ka", "カ"}, {"ki", "キ"}, {"ky", "キィ"}, {"ku", "ク"}, {"ke", "ケ"}, {"ko", "コ"},
                // c
                {"ca", "カ"}, {"ci", "シ"}, {"cy", "シィ"}, {"cu", "ク"}, {"ce", "セ"}, {"co", "コ"},
                // sh
                {"sha", "シャ"}, {"shi", "シ"}, {"shy", "シィ"}, {"shu", "シュ"}, {"she", "シェ"}, {"sho", "ショ"},
                // ch
                {"cha", "チャ"}, {"chi", "チ"}, {"chy", "チィ"}, {"chu", "チュ"}, {"che", "チェ"}, {"cho", "チョ"},
                {"ch", "チ"},
                // s
                {"sa", "サ"}, {"si", "スィ"}, {"sy", "スィ"}, {"su", "ス"}, {"se", "セ"}, {"so", "ソ"},
                {"s", "ズ"}, {"es", "エズ"},
                // t
                {"ta", "タ"}, {"tu", "トゥ"}, {"te", "テ"}, {"to", "ト"}, {"tsu", "ツ"},
                // n
                {"na", "ナ"}, {"ni", "ニ"}, {"ny", "ニィ"}, {"nu", "ヌ"}, {"ne", "ネ"}, {"no", "ノ"},
                {"nya", "ニャ"}, {"nyu", "ニュ"}, {"nyo", "ニョ"},
                // ñ
                {"ña", "ニャ"}, {"ñi", "ニィ"}, {"ñy", "ニィ"}, {"ñu", "ニュ"}, {"ñe", "ニェ"}, {"ño", "ニョ"},
                // h
                {"ha", "ハ"}, {"hi", "ヒ"}, {"hy", "ヒィ"}, {"fu", "フ"}, {"he", "ヘ"}, {"ho", "ホ"},
                {"hya", "ヒャ"}, {"hyu", "ヒュ"}, {"hyo", "ヒョ"},
                // m
                {"ma", "マ"}, {"mi", "ミ"}, {"my", "ミィ"}, {"mu", "ム"}, {"me", "メ"}, {"mo", "モ"},
                {"mya", "ミャ"}, {"myu", "ミュ"}, {"myo", "ミョ"},
                {"m", "ム"},
                // y
                {"ya", "ヤ"}, {"yi", "イィ"}, {"yy", "イィ"}, {"yu", "ユ"}, {"ye", "イェ"}, {"yo", "ヨ"},
                // l
                {"la", "ラ"}, {"li", "リ"}, {"ly", "リィ"}, {"lu", "ル"}, {"le", "レ"}, {"lo", "ロ"},
                // ll
                {"lla", "ラ"}, {"lli", "リ"}, {"lly", "リィ"}, {"llu", "ル"}, {"lle", "レ"}, {"llo", "ロ"},
                {"ll", "リ"},
                // r
                {"ra", "ラ"}, {"ri", "リ"}, {"ry", "リィ"}, {"ru", "ル"}, {"re", "レ"}, {"ro", "ロ"},
                {"rya", "リャ"}, {"ryu", "リュ"}, {"ryo", "リョ"},
                // w
                {"wa", "ワ"}, {"wi", "ウィ"}, {"wy", "ウィ"}, {"wu", "ウ"}, {"we", "ウェ"}, {"wo", "ウォ"},
                // g
                {"ga", "ガ"}, {"gi", "ギ"}, {"gy", "ギィ"}, {"gu", "グ"}, {"ge", "ゲ"}, {"go", "ゴ"},
                {"gya", "ギャ"}, {"gyu", "ギュ"}, {"gyo", "ギョ"},
                // z
                {"za", "ザ"}, {"zu", "ズ"}, {"ze", "ゼ"}, {"zo", "ゾ"},
                // d
                ...
                // b
                {"ba", "バ"}, {"bi", "ビ"}, {"by", "ビィ"}, {"bu", "ブ"}, {"be", "ベ"}, {"bo", "ボ"},
                {"bya", "ビャ"}, {"byu", "ビュ"}, {"byo", "ビョ"},
                {"b", "ブ"},
                // p
                {"pa", "パ"}, {"pi", "ピ"}, {"py", "ピィ"}, {"pu", "プ"}, {"pe", "ペ"}, {"po", "ポ"},
                {"pya", "ピャ"}, {"pyu", "ピュ"}, {"pyo", "ピョ"},
                // f
                {"fa", "ファ"}, {"fi", "フィ"}, {"fe", "フェ"}, {"fo", "フォ"},
                // j
                {"ja", "ジャ"}, {"ji", "ジ"}, {"jy", "ジィ"}, {"ju", "ジュ"}, {"je", "ジェ"}, {"jo", "ジョ"},
                // n (final nasal)
                {"an", "アン"}, {"in", "イン"}, {"yn", "イン"}, {"un", "ウン"}, {"en", "エン"}, {"on", "オン"}, {"n", "ン"},
                // numbers
                {"0", "ゼロ"}, {"1", "ワン"}, {"2", "ツー"}, {"3", "スリー"}, {"4", "フォー"}, {"5", "ファイブ"}, {"6", "シックス"},
                {"7", "セブン"}, {"8", "エイト"}, {"9", "ナイン"},
                // Special characters
                {"º", "オ"}, {"ª", "ア"},
                // Distance
                {"cm", "センチメートル"}, {"mm", "ミリメートル"}, {"km", "キロメートル"},
                // Weight
                {"cg", "センチグラム"}, {"mg", "ミリグラム"}, {"kg", "キログラム"},
                // extra
                {"name", "ネーム"}, {"thank you", "サンキュー"},
                {"r", "アール"}, {"p", "ピー"}, {"t", "ティー"}, {"h", "エイチ"}, {"k", "ケイ"}, {"v", "ヴィー"},
                {"z", "ゼット"}, {"d", "ディー"}, {"g", "ジー"}, {"c", "シー"}, {"j", "ジェー"}, {"f", "エフ"},
                {"x", "エックス"}, {"w", "ダブリュー"}, {"xu", "エックスユー"}, {"l", "エル"}, {"ñ", "エニェ"},
            };
