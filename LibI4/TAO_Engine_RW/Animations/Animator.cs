...
namespace TAO.Engine.Animations
{
    public static class Animator
    {
        ...
        public static void PlayMultipleAnimations(params int[] Indexes)
        {
        ...
        public static void PlayMultipleAnimations(params Animation[] Anims)
        {
